...
#define MCTRCONTROL_M_ENABLE        (1ULL << 0)
#define MCTRCONTROL_S_ENABLE        (1ULL << 1)
#define MCTRCONTROL_U_ENABLE        (1ULL << 2)
#define MCTRCONTROL_CLR             (1ULL << 7)
#define MCTRCONTROL_MTE             (1ULL << 8)
#define MCTRCONTROL_STE             (1ULL << 9)
#define MCTRCONTROL_RASEMU          (1ULL << 10)
#define MCTRCONTROL_BPFRZ           (1ULL << 11)
#define MCTRCONTROL_LCOFIFRZ        (1ULL << 12)
#define MCTRCONTROL_DEPTH_MASK      0xE0000ULL
#define MCTRCONTROL_EXCINH          (1ULL << 33)
#define MCTRCONTROL_INTRINH         (1ULL << 34)
#define MCTRCONTROL_TRETINH         (1ULL << 35)
#define MCTRCONTROL_NTBREN          (1ULL << 36)
#define MCTRCONTROL_TKBRINH         (1ULL << 37)
#define MCTRCONTROL_ETEN            (1ULL << 38)
#define MCTRCONTROL_INDCALL_INH     (1ULL << 40)
#define MCTRCONTROL_DIRCALL_INH     (1ULL << 41)
#define MCTRCONTROL_INDJUMP_INH     (1ULL << 42)
#define MCTRCONTROL_DIRJUMP_INH     (1ULL << 43)
#define MCTRCONTROL_CORSWAP_INH     (1ULL << 44)
#define MCTRCONTROL_RET_INH         (1ULL << 45)
#define MCTRCONTROL_INDOJUMP_INH    (1ULL << 46)
#define MCTRCONTROL_DIROJUMP_INH    (1ULL << 47)

#define MCTRCONTROL_INH_START       33
#define MCTRCONTROL_DEPTH_MIN       0x0 /* 16 Entries. */
#define MCTRCONTROL_DEPTH_MAX       0x4 /* 256 Entries. */
...
#define MCTRCONTROL_MASK (MCTRCONTROL_M_ENABLE | MCTRCONTROL_S_ENABLE | \
                          ...
                          MCTRCONTROL_NTBREN | MCTRCONTROL_TKBRINH | MCTRCONTROL_ETEN | \
...
#define CTRSOURCE_VALID   (1ULL << 0)

#define CTRTARGET_MISP    (1ULL << 0)
...
#define MISELECT_CTR_START  0x200
#define MISELECT_CTR_END    0x2ff

#define VSISELECT_CTR_START  MISELECT_CTR_START
#define VSISELECT_CTR_END    MISELECT_CTR_END
...
#define SISELECT_CTR_START  MISELECT_CTR_START
#define SISELECT_CTR_END    MISELECT_CTR_END
...
#define HSTATEEN0_SCSRIND  0x1000000000000000 // Alias for the above for legacy reasons
...
#define SCTRCONTROL_NTBREN        MCTRCONTROL_NTBREN
#define SCTRCONTROL_TKBRINH       MCTRCONTROL_TKBRINH
...
#define SCTRCONTROL_MASK (SCTRCONTROL_S_ENABLE | SCTRCONTROL_U_ENABLE | \
                          ...
                          SCTRCONTROL_TRETINH | SCTRCONTROL_NTBREN | SCTRCONTROL_TKBRINH | \
...
#define SCTRSTATUS_FROZEN           (1ULL << 31)
...
#define VSCTRCONTROL_NTBREN            MCTRCONTROL_NTBREN
#define VSCTRCONTROL_TKBRINH           MCTRCONTROL_TKBRINH
...
#define VSCTRCONTROL_W_MASK (VSCTRCONTROL_VS_ENABLE | VSCTRCONTROL_VU_ENABLE | \
                             ...
                             VSCTRCONTROL_NTBREN | VSCTRCONTROL_TKBRINH | VSCTRCONTROL_ETEN | \
...
#define VSCTRCONTROL_R_MASK (VSCTRCONTROL_W_MASK | VSCTRCONTROL_DEPTH_MASK)

/* vsctrstatus CSR bits. */
#define VSCTRSTATUS_WRPTR_MASK       MCTRSTATUS_WRPTR_MASK
#define VSCTRSTATUS_WRAP             MCTRSTATUS_WRAP
#define VSCTRSTATUS_FROZEN           MCTRSTATUS_FROZEN

#define VSCTRSTATUS_MASK     (VSCTRSTATUS_WRPTR_MASK | VSCTRSTATUS_WRAP | \
                              VSCTRSTATUS_FROZEN)
...
#define CSR_VSCTRCONTROL 0x24E
#define CSR_VSCTRSTATUS 0x24F
...
DECLARE_CSR(sctrcontrol, CSR_SCTRCONTROL)
...
DECLARE_CSR(vsctrcontrol, CSR_VSCTRCONTROL)
DECLARE_CSR(vsctrstatus, CSR_VSCTRSTATUS)
...
DECLARE_CSR(mctrcontrol, CSR_MCTRCONTROL)
